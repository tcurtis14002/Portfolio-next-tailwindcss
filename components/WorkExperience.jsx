...
function WorkExperience() {
	return (
		<motion.div
			...
			className='align-center relative mx-auto flex h-screen max-w-7xl flex-col items-center justify-center px-10 text-center md:flex-row md:text-left'>
			<h3 className='pb-auto align-center absolute top-24 mx-auto items-center text-center text-2xl uppercase tracking-[20px] text-gray-500'>
				Experience
			</h3>
